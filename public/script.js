...
function createViewSupag() {
    ...
    let loader = `<div class="flex w-[100%] justify-center items-center">
                  <svg role="status" class="mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-zinc-800 dark:fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        .then(data => {
            for (let index = 0; index < data.length; index++) {
                ...
                itemList += `<div class="m-4 mt-8 border-b-2 border-zinc-700">
                                ...
                                <p class="text-3xl text-justify leading-relaxed font-['fontArab'] my-6 dark:text-zinc-300" dir="rtl">${item.core}</p> 
                                <p class="text-justify mb-6 dark:text-zinc-300">${item.terjemah}</p>
                            </div>`;
            }
        ...
        .then(data => {
            for (let index = 0; index < data.length; index++) {
                ...
                doaList += `<div class="m-4 mt-8 border-b-2 border-green-600">
                                ...
                                <p class="text-3xl text-justify leading-relaxed font-['fontArab'] my-6 dark:text-zinc-300" dir="rtl">${doa.core}</p> 
                                <p class="text-justify mb-6 dark:text-zinc-300">${doa.terjemah}</p>
                            </div>`;
            }
